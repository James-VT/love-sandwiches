...
def calculate_surplus_data(sales_row):
    """
    Compare sales with sock and calculate the surplus for each item type.
...
def calculate_stock_data(data):
    """
    Calulate the average stock for each item type, adding 10%
    """
...
def get_stock_values():
    ...
    for head, figure in zip(headings, dummy_data):
